## =====================================================================
## Fit the NO2 models for Section 6
## =====================================================================
library(Matrix)
library(fmesher)
library(INLA)
...
## Greedily add the candidate that most improves the adjusted R^2 of an OLS
## regression of y on the covariates chosen so far, but only if its coefficient
## has the physically expected sign (`signs`) and the gain exceeds 0.01.  Stop
...
## `n_cov`  = covariates estimated from data 
fits <- list()
results <- list()
